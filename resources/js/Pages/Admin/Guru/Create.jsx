    ...
    return (
        <AdminLayout>
            ...
            <div className="mb-8">
                ...
                <h1 className="text-3xl font-black text-slate-900 tracking-tight">Tambah Guru Baru</h1>
                <p className="text-slate-500 mt-1">Tambahkan pengajar baru ke dalam sistem akademik.</p>
            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-8">
                        <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/50">
                            <h3 className="font-bold text-lg text-slate-800 mb-6 border-b border-slate-100 pb-4">Informasi Pribadi</h3>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label className="block text-sm font-bold text-slate-700 mb-2">NIP (Nomor Induk Pegawai)</label>
                                        <input 
                                            type="text" 
                                            value={data.nip} 
                                            onChange={e => setData('nip', e.target.value)} 
                                            className="w-full px-5 py-3.5 bg-slate-50 border-none rounded-2xl focus:ring-2 focus:ring-brandPrimary/50 font-medium placeholder:text-slate-400 font-mono" 
                                            placeholder="199801..." 
                                        />
