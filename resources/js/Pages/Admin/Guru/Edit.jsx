...
export default function Edit({ teacher }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('admin.guru.update', teacher.id), {
            forceFormData: true,
        });
    };
    ...
    return (
        <AdminLayout>
            ...
            <div className="mb-8">
                ...
                <h1 className="text-3xl font-black text-slate-900 tracking-tight">Edit Data Guru</h1>
            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-4">
                        <div className="bg-white p-6 rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/50 text-center sticky top-8">
                            ...
                            <div className="relative w-48 h-48 mx-auto group">
                                <div className={`w-full h-full rounded-full overflow-hidden border-4 border-white shadow-lg ring-1 ${errors.avatar ? 'ring-red-500' : 'ring-slate-100'} bg-slate-50 flex items-center justify-center relative`}>
                                    {preview ? (
                                        ...
                                        <UserAvatar user={teacher} className="w-full h-full text-6xl" />
                                    )}
                            ...
                            <div className="mt-6 pb-6 border-b border-slate-100">
                                <p className="text-slate-900 font-black text-xl">{teacher.name}</p>
                                <p className="text-slate-500 text-sm font-mono mt-1">{teacher.nip || 'NIP Belum diatur'}</p>
                            </div>
                    ...
                    <div className="lg:col-span-8">
                        <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/50">
                            <h3 className="font-bold text-lg text-slate-800 mb-8 border-b border-slate-100 pb-4">Detail Data Guru</h3>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label className="block text-sm font-bold text-slate-700 mb-2">NIP</label>
                                        <input 
                                            type="text" 
                                            value={data.nip} 
                                            ...
                                            placeholder="Kosong"
                                        />
                                        {errors.nip && <p className="text-red-500 text-xs mt-2 font-bold">{errors.nip}</p>}
                                    </div>
                                    ...
                                    <div className="flex items-start gap-4 mb-6">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-amber-700/80 mt-1">
                                                Isi kolom ini <span className="font-bold">hanya jika</span> Anda ingin mengganti password guru ini.
                                            </p>
                                        </div>
                                    </div>
