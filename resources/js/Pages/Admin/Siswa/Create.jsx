    ...
    return (
        <AdminLayout>
            ...
            <div className="mb-8">
                ...
                <h1 className="text-3xl font-black text-slate-900 tracking-tight">Tambah Siswa Baru</h1>
                <p className="text-slate-500 mt-1">Daftarkan siswa baru ke dalam sistem akademik.</p>
            </div>
                        ...
                        <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/50">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label className="block text-sm font-bold text-slate-700 mb-2">NIS (Nomor Induk Siswa)</label>
                                        <input 
                                            type="text" 
                                            value={data.nis} 
